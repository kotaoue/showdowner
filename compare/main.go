...
func findBenchmarkFiles() ([]string, error) {
	patterns := []string{"../go/benchmark_*.json", "../php/benchmark_*.json", "../python2/benchmark_*.json", "../python3/benchmark_*.json", "../rust/benchmark_*.json", "../javascript/benchmark_*.json"}
	var files []string
